pipeline{
    ...
    stages{
        ...
        success{
            echo "Success.....!!!"
            mail bcc: '', body: 'The Pipeline is Executed: Successfully', cc: '', from: '', replyTo: '', subject: 'The Pipeline is Executed: Successfully', to: 'Krushnabhanage10@gmail.com'
        }
        failure{
            echo "Failure,,, Kindly check the pipline file in repo"
            mail bcc: '', body: 'The Pipeline is Executed: Failed', cc: '', from: '', replyTo: '', subject: 'The Pipeline is Executed: Failed', to: 'Krushnabhanage10@gmail.com'
        }
        }
}
